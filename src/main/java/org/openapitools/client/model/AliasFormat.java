 ...
 */
@JsonAdapter(AliasFormat.Adapter.class)
public enum AliasFormat {
  ...
  public static AliasFormat fromValue(String value) {
    for (AliasFormat b : AliasFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<AliasFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final AliasFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AliasFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AliasFormat.fromValue(value);
    }
  }
}
